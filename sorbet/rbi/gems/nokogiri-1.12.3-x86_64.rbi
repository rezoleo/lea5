...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_30
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_31
end
...
class Nokogiri::HTML4::EntityDescription < Anonymous_Struct_32
end
