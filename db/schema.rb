...
ActiveRecord::Schema[7.0].define(version: 2023_02_12_181444) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.virtual "duration", type: :integer, comment: "Duration in months", as: "EXTRACT(months FROM age(end_at, start_at))", stored: true
