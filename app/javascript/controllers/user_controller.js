...
export default class extends Controller {
  ...
  togglePasswordVisibility() {
    ...
    if (
      passwordField.classList.contains(
        "card-content-user-details-password-hidden"
      )
    ) {
      passwordField.classList.replace(
        "card-content-user-details-password-hidden",
        "card-content-user-details-password-visible"
      )
